...
pass_od <- read_sf("data/od_flights_pass_2024.gpkg")
names(pass_od) <- c("airport1","airport1_country","airport2","airport2_country",
                    paste0("pass_",1990:2024),
                    paste0("flt_",1990:2024),
...
distbnd <- function(x){
  ...
  if(x %in% c("Ascension Island","Virgin Islands (U.s.a)","Somali Republic","Isle of Diego Garcia")){
    return("longhaul")
  }
...
pass_od$continent[pass_od$airport2_country == "Isle of Diego Garcia"] <- "Asia"
...
pass_od <- pass_od[,c("airport1","airport1_country","airport2","airport2_country",
                      ...
                      paste0("pass_",1990:2024),
                      paste0("flt_",1990:2024),
                      paste0("pass_km_",1990:2024),
                      paste0("emissions_",1990:2024),
                      "geom")]


write_sf(pass_od, "data/od_emissions_2024.gpkg")
