...
names(flow) <- c("airport1","airport2","airport2_country",paste0("flt_",1990:max_year))
...
flow <- flow[,c("airport1","airport1_country","airport2_country","airport2",paste0("flt_",1990:max_year))]

saveRDS(flow,"data/flights_od_2024.Rds")
